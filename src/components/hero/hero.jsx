...
const Hero = () => {
  return (
    <div className="hero bg-blend-overlay pt-14">
    <div className="hero-content text-center">
      <div className="max-w-xl">
        <h1 className="text-6xl font-bold max-md:text-4xl text-white">Best E-Commerce Shop Of The Year!</h1>
        <p className="py-3 text-2xl max-md:text-lg text-white">
