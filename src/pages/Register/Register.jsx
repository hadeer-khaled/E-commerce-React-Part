...
return (
    <section className="bg-gray-50 dark:bg-gray-900 heig">
    <div className="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
        ...
        {/* Last Name */}
            ...
            {formik.touched.first_name && <p className="right-0">{formik.errors.first_name}</p>}
            {formik.touched.last_name && <p className="left-0">{formik.errors.last_name}</p>}
        ...
        <div>
            ...
            />
            {formik.touched.confirm_password && <p>{formik.errors.confirm_password}</p>}
            </div>
